...
1. Call `runner_start` for the repository. Executor metadata binds this task as the dashboard owner for live counter titles. The runner owns its persistent app-server connection and task sessions.
